...
class CustomerSchoolRegistrationFormPage extends StatefulWidget {
  const CustomerSchoolRegistrationFormPage({Key? key}) : super(key: key);

  @override
  State<CustomerSchoolRegistrationFormPage> createState() =>
      _CustomerSchoolRegistrationFormPageState();
}

class _CustomerSchoolRegistrationFormPageState
    extends State<CustomerSchoolRegistrationFormPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          ...
          elevation: 0,
          centerTitle: false,
          title: const Text("Customer School Form", style: whiteColorTextStyle),
          actions: [
            Bounce(
