...
class ChannelPartnerRegistrationFormPage extends StatefulWidget {
  const ChannelPartnerRegistrationFormPage({Key? key}) : super(key: key);

  @override
  State<ChannelPartnerRegistrationFormPage> createState() =>
      _ChannelPartnerRegistrationFormPageState();
}

class _ChannelPartnerRegistrationFormPageState
    extends State<ChannelPartnerRegistrationFormPage> {
  TextEditingController partnersFirmNameController = TextEditingController();
  TextEditingController partnersNameController = TextEditingController();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          ...
          elevation: 0,
          centerTitle: false,
          title: const Text("Channel Partner Form", style: whiteColorTextStyle),
          actions: [
            Bounce(
        ...
        body: SingleChildScrollView(
          ...
          child: Column(children: [
            ...
            _partnersFirmNameFieldView(),
            const SizedBox(height: 5),
            _partnersNameFieldView(),
            const SizedBox(height: 5),
                        ...
                        return InkWell(
                          child: Container(
                              ...
                              child: Padding(
                                ...
                                child: Text(partnersList[index],
                                    style: whiteColorTextStyle),
                              )),
                          onTap: () {
                            setState(() {
                              _chosenValue = partnersList[index];
                            });
      ...
      child: Card(
          ...
          child: Center(
            child: TextField(
              ...
              controller: partnersFirmNameController,
              ...
              decoration: InputDecoration(
                ...
                hintText: "Channel Partner's Firm Name*",
    ...
    return SizedBox(
      ...
      child: Card(
          ...
          child: Center(
            child: TextField(
              keyboardType: TextInputType.name,
              controller: partnersNameController,
              cursorHeight: SpacingUtils.space20,
              textAlignVertical: TextAlignVertical.center,
              cursorColor: AppColors.mainDarkColor,
              style: inputTextStyle,
              ...
              decoration: InputDecoration(
                ...
                contentPadding:
                    const EdgeInsets.only(left: SpacingUtils.space15),
                hintText: "Channel Partner's Name*",
                hintStyle: hintTextStyle,
              ),
            ),
          )),
