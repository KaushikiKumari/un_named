...
class PartnerRegistrationFormPage extends StatefulWidget {
  const PartnerRegistrationFormPage({Key? key}) : super(key: key);

  @override
  State<PartnerRegistrationFormPage> createState() =>
      _PartnerRegistrationFormPageState();
}

class _PartnerRegistrationFormPageState
    extends State<PartnerRegistrationFormPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          ...
          elevation: 0,
          centerTitle: false,
          title: const Text("Partner Registration Form",
