...
class CustomerCollegeRegistrationFormPage extends StatefulWidget {
  const CustomerCollegeRegistrationFormPage({Key? key}) : super(key: key);

  @override
  State<CustomerCollegeRegistrationFormPage> createState() =>
      _CustomerCollegeRegistrationFormPageState();
}

class _CustomerCollegeRegistrationFormPageState
    extends State<CustomerCollegeRegistrationFormPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          ...
          centerTitle: false,
          title:
              const Text("Customer College Form", style: whiteColorTextStyle),
          actions: [
            Bounce(
