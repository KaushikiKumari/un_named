...
class UserRegistrationFormPage extends StatefulWidget {
  const UserRegistrationFormPage({Key? key}) : super(key: key);

  @override
  State<UserRegistrationFormPage> createState() =>
      _UserRegistrationFormPageState();
}

class _UserRegistrationFormPageState extends State<UserRegistrationFormPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          ...
          centerTitle: false,
          title:
              const Text("User Registration Form", style: whiteColorTextStyle),
          actions: [
            Bounce(
